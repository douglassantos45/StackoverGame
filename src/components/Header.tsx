    ...
    <header className="py-4 mb-16 w-full h-20 bg-background px-4 fixed inset-0 z-50">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="font-semibold text-purple-600 lg:text-xl">StackOverGame</h1>
        </div>
        <UIDropdownMenu.Root>
          <UIDropdownMenu.Trigger className=" cursor-pointer outline-0">
            <img src="profile.png" alt="" className="max-w-[40px]" />
...
n-300 mr-1"
          >
            ...
            <UIDropdownMenu.Item className="text-gray-300 hover:text-gray-400 outline-0 transition py-1 pl-3">
            <i className="fa-solid fa-arrow-right-from-bracket mr-2 text-gray-400"></i>Sair
            </UIDropdownMenu.Item>
          </UIDropdownMenu.Content>
        </UIDropdownMenu.Root>
      </div>
